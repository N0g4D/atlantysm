...
library CrystalBalance {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "CrystalBalance", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746261707000000000000000000000004372797374616c42616c616e63650000);
   ...
   * @notice Get count.
   */
  function getCount(address owner) internal view returns (uint256 count) {
   ...
   * @notice Get count.
   */
  function _getCount(address owner) internal view returns (uint256 count) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(owner)));
   ...
   * @notice Get count.
   */
  function get(address owner) internal view returns (uint256 count) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(owner)));
   ...
   * @notice Get count.
   */
  function _get(address owner) internal view returns (uint256 count) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(owner)));
   ...
   * @notice Set count.
   */
  function setCount(address owner, uint256 count) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(owner)));
   ...
   * @notice Set count.
   */
  function _setCount(address owner, uint256 count) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(owner)));
   ...
   * @notice Set count.
   */
  function set(address owner, uint256 count) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(owner)));
   ...
   * @notice Set count.
   */
  function _set(address owner, uint256 count) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(owner)));
