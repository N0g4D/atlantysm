...
library CrystalOwner {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "CrystalOwner", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746261707000000000000000000000004372797374616c4f776e657200000000);
   ...
   * @notice Get owner.
   */
  function get(bytes32 id) internal view returns (address owner) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Get owner.
   */
  function _get(bytes32 id) internal view returns (address owner) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Set owner.
   */
  function set(bytes32 id, address owner) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Set owner.
   */
  function _set(bytes32 id, address owner) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
